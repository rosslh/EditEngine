...
def process_edit_task(self, editing_mode, llm_config, edit_task_id, **kwargs):
    ...
    Args:
        ...
        llm_config: Configuration for initializing the LLM
    ...
    try:
        ...
        def enhanced_progress_callback(progress_data):
            ...
            edit_task.update_progress_enhanced(progress_data)
